...
public class SiteCustomDTO implements PropertiesAndCategoriesDTO {
    ...
    @Schema(description = "Custom properties associated to the site")
    private Map<String, Object> properties;

    @Schema(description = "Custom categories associated to the site")
